...
# HappyTag macOS Verbose Debug Build
...
a = Analysis(
    ...
    hookspath=[],
    hooksconfig={},
    runtime_hooks=['runtime_hook_debug.py'],  # Enable verbose debug configuration
    excludes=[],
...
app = BUNDLE(
    coll,
    name='HappyTag_VerboseDebug_macOS.app',  # Name triggers verbose debug mode
    icon=None,
    bundle_identifier='com.happytag.verbosedebug.app',
    version='1.0.0-verbosedebug',
    info_plist={
        'CFBundleName': 'HappyTag Verbose Debug',
        'CFBundleDisplayName': 'HappyTag Verbose Debug',
        'CFBundleIdentifier': 'com.happytag.verbosedebug.app',
        'CFBundleVersion': '1.0.0-verbosedebug',
        'CFBundleShortVersionString': '1.0.0-verbosedebug',
